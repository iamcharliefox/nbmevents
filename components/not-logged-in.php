<?php get_template_part( 'components/hero-large-with-date'); ?>
<div class="not-logged-in">
    <div class="container">
        <div class="info-box">
            ...
            <a href="<?php echo esc_url( wp_login_url( get_permalink() ) ); ?>" class="button blue-solid" alt="<?php esc_attr_e( 'Login', 'textdomain' ); ?>">
