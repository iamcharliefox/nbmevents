...
<?php if ( is_user_logged_in() ): ?><?php get_template_part( 'components/user-bar'); ?><?php endif; ?>
...
<?php if ( is_user_logged_in() ): ?>
  ...
  <?php if ($show_status == "VIP") : ?>
    ...
    <?php if (check_user_roles( array( 'administrator', 'staff', 'sponsor' ) )) : ?>
      <?php get_template_part( 'components/hero-large'); ?>
      <?php get_template_part( 'components/title-sponsors'); ?>
